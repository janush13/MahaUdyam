 ...
 * empty. Every storage operation goes through this (the document module
 * additionally generates its keys server-side) — a document key must never be
 * treated as a trustworthy filesystem path on its own.
 */
