...
// Full AppModule boot (ts-jest compile + Prisma pool) is slow when the e2e
// suites run in parallel; the 5s default made beforeAll flaky. Same approach
// as the auth e2e suites.
